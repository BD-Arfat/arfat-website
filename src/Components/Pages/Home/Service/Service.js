...
const Service = () => {
    return (
        <div className='about pt-14 pb-20 mt-10'>
            ...
            <div className=' grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16'>
                {/* 1 */}
                <div className="card md:w-96 bg-info text-center text-primary-content">
