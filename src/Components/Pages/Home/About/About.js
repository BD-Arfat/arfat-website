                    ...
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <div className='text-justify w-1/2'>
                            ...
                            <div className='flex items-center justify-between'>
                                <div>
                                    <h1 className='text-xl font-bold about-text'>Email : arfat1islam5162@gmail.com</h1>
                                    <h1 className='text-xl font-bold about-text'>Contact Number : +8801846615162</h1>
                                    <h1 className='text-xl font-bold about-text'>Address : Chittagong, Bangladesh</h1>
